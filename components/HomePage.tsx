        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={idx}
                className="relative aspect-[1/1] overflow-hidden group"
              >
                <img
                  src={svc.img}
                  alt={svc.title}
                ...
                <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
                  ...
                  <button className="border-2 border-white text-white px-5 py-2 font-semibold hover:bg-white hover:text-black transition">
                    View Details
                  </button>
                </div>
              </div>
